...
%description -l pl
Atlas-C++ jest implementacj± (w jÍzyku C++) protoko≥u Atlas, warstwy
komunikacyjnej przeznaczonej do systemÛw WorldForge MMORPG. BibliotekÍ
tÍ przygotowano zarÛwno dla aplikacji klienckich, jak i serwerÛw.

%package devel
Summary:	Header files for Atlas-C++ development
Summary(pl):	Pliki nag≥Ûwkowe do biblioteki Atlas-C++
